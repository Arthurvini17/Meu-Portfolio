...
export default function ItensCardWeb({ title, icon, href }: ItensCardWebProps) {
    return (
        ...
        <a href={href} className="block transition-transform hover:scale-105">
            <div className="flex items-center gap-4 px-4 py-3 rounded-md shadow-md w-full max-w-60 bg-[#0B0F1A] border border-[#1F2937] hover:border-[#3BA9F4] group transition-colors">
